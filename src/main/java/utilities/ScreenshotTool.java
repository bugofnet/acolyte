...
public class ScreenshotTool {
    ...
    public static String takeScreenshot(String screenshotFileName) {
        ...
        File sourceFile = ((TakesScreenshot) Driver.driver).getScreenshotAs(OutputType.FILE);
...
//        return destinationPath;
    ...
    public static String takeScreenshotEntirePage(String screenshotFileName) {
        ...
        Screenshot screenshot = new AShot().shootingStrategy(ShootingStrategies.viewportPasting(100)).takeScreenshot(Driver.driver);
